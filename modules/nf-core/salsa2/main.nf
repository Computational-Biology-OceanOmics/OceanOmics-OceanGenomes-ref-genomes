process SALSA2 {
    ...
    output:
    tuple val(meta), path("*.fasta")	                , emit: salsa_fasta
    tuple val(meta), path("*.agp")	                    , emit: salsa_agp
    ...
    mv */scaffolds_FINAL.fasta ${prefix}${haplotype}.fasta
    mv */scaffolds_FINAL.agp ${prefix}${haplotype}.agp
