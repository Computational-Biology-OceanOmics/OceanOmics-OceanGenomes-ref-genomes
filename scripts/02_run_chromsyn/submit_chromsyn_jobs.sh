...
SAMPLE_SHEET="/scratch/pawsey0964/${USER}/ref-gen/OceanOmics-OceanGenomes-ref-genomes/assets/samplesheet_hichifi_20260629_1.csv"


# Path to the chromsyn.sh script
CHROMSYN_SCRIPT="/scratch/pawsey0964/${USER}/ref-gen/OceanOmics-OceanGenomes-ref-genomes/scripts/02_run_chromsyn/chromsyn.sh"
...
tail -n +2 "$SAMPLE_SHEET" | while IFS=',' read -r sample hifi_dir hic_dir version date tolid taxid species; do
    ...
    OUTPUT_DIR="/scratch/pawsey0964/${USER}/ref-gen/${sample}/09-chromsyn"
