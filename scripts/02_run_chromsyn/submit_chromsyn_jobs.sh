...
SAMPLE_SHEET="/scratch/pawsey0964/lhuet/ref-gen/salsa/OceanOmics-OceanGenomes-ref-genomes/assets/samplesheet.csv"

# Path to the chromsyn.sh script
CHROMSYN_SCRIPT="/scratch/pawsey0964/lhuet/ref-gen/salsa/OceanOmics-OceanGenomes-ref-genomes/scripts/02_run_chromsyn/chromsyn.sh"
